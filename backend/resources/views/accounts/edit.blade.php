...
<head>
    ...
    <title>Edit Account - OPF-CD</title>
...
<body x-data="accountEdit()" x-init="init()">
    <div class="container">
        <div class="breadcrumb">
            ...
            <span>→</span>
            <span style="opacity: 1;">Edit Account</span>
        </div>
        <div class="card">
            ...
            <div class="card-body">
                <div x-show="loading" class="loading">Loading account details...</div>
    ...
    <script>
        function accountEdit() {
            return {
                ...
                init() {
                    // Extract account ID from URL path: /accounts/{id}/edit
                    const pathParts = window.location.pathname.split('/');
                    this.accountId = pathParts[pathParts.length - 2];
                    this.fetchAccount();
                },
                ...
                async fetchAccount() {
                    try {
                        ...
                        this.error = 'An error occurred while loading account.';
                    } finally {
                        this.loading = false;
                    }
                },
                ...
                async submitUpdate() {
                    ...
                    try {
                        ...
                        if (response.ok && data.success) {
                            ...
                            this.error = data.message || 'Failed to update account. Please try again.';
                        }
                    } catch (error) {
