...
<head>
    ...
    <title>Create Opportunity - OPF-CD</title>
...
<body class="min-h-full bg-slate-950 text-gray-100">
    <div class="min-h-screen p-8" x-data="opportunityCreate()">
        <!-- Header -->
        <div class="max-w-3xl mx-auto mb-8">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold">Create New Opportunity</h1>
                    <p class="text-gray-400 mt-1">Add a new sales opportunity</p>
                </div>
        ...
        <div class="max-w-3xl mx-auto">
            <form @submit.prevent="submitOpportunity" class="rounded-xl bg-white/5 backdrop-blur-xl border border-white/10 p-8 space-y-6">
                <!-- Client -->
                <div>
                ...
                <div>
                    ...
                    <input type="date" x-model="form.expected_close_date" required :min="today"
                           class="w-full px-4 py-2 rounded-lg bg-white/5 border border-white/10 text-gray-100 focus:outline-none focus:border-indigo-500 transition-colors">
                ...
                <div class="flex justify-end gap-4">
                    ...
                    <button type="submit" :disabled="submitting"
                        ...
                        <span x-show="!submitting">Create Opportunity</span>
                ...
                async submitOpportunity() {
                    ...
                    try {
                        ...
                        if (!response.ok) {
                            ...
                            this.errorMessage = data.message || 'Failed to create opportunity';
                            return;
                        }

                        this.successMessage = data.message || 'Opportunity created successfully!';
