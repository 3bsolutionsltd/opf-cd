...
<head>
    ...
    <title>Create Project - OPF-CD</title>
...
<body class="min-h-full bg-slate-950 text-gray-100">
    <div class="min-h-screen p-8" x-data="projectCreate()">
        <!-- Header -->
        <div class="max-w-3xl mx-auto mb-8">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold">Create Project</h1>
                    <p class="text-gray-400 mt-1">Add a new project to the system</p>
                </div>
        ...
        <div class="max-w-3xl mx-auto">
            <form @submit.prevent="submitProject" class="rounded-xl bg-white/5 backdrop-blur-xl border border-white/10 p-8 space-y-6">
                    ...
                    try {
                        ...
                        if (data.success) {
                            ...
                            if (data.errors) {
                                ...
                                this.errorMessage = data.message || 'Failed to create project';
                            }
                        }
                    } catch (e) {
                        this.errorMessage = 'Error creating project: ' + e.message;
                    } finally {
